...
const painters = {
  ...
  tamaplaza(ctx, g) {
    ...
    for (let i = -1; i < W / unit + 2; i++) {
      ...
      signboard(ctx, x + 78, groundY - 186, 174, 26, "たまプラーザ", "#f7f4ea", "#2b3a4a", 15);
      // 高架のライン
      ctx.fillStyle = "#98a0a8";
      ctx.fillRect(x, groundY - 176, 330, 10);
      // ホーム上屋
      ctx.fillStyle = "#c8ccd2";
      ctx.fillRect(x + 348, groundY - 74, 96, 8);
      for (let p = 0; p < 3; p++) ctx.fillRect(x + 352 + p * 42, groundY - 66, 5, 66);
    }
  },
